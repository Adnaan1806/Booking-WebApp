...
useEffect(() => {
  ...
  return profileData && (
    ...
    <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
      ...
      {
        isEdit ? <button onClick={updateProfile} className='px-4 py-1 border border-primary text-sm rounded-lg mt-5 hover:bg-primary hover:text-white transition-all duration-300'>Save</button>
        : <button onClick={() => setIsEdit(true)} className='px-4 py-1 border border-primary text-sm rounded-lg mt-5 hover:bg-primary hover:text-white transition-all duration-300'>Edit</button>
